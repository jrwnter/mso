...
class Swarm:
    """
    Class that defines a Swarm that can be optimized by a PSOptimizer. Most PSO calculations are done in here.
    """
    def __init__(self, smiles, x, v, x_min=-1., x_max=1.,
                 inertia_weight=0.9, phi1=2., phi2=2., phi3=2.):
        """
        :param smiles: The SMILES that define the molecules at the positions of the particles of the swarm.
    ...
    def update_fitness(self, fitness):
        """
        Updates the fitness of the particles in the swarm. Also updates swarm properties such as the best positions
        (highest fitness) of the whole swarm and each individual particle.
    ...
    def from_dict(cls, dictionary):
        """
        Classmethod to create a Swarm instance from a dictionary. Can be used to reinitialize a Swarm with all important
            properties.
    ...
    def from_query(cls, init_sml, init_emb, num_part, v_min=-0.6, v_max=0.6,*args, **kwargs):
        """
        Classmethod to create a new Swarm instance from a single query. All particles are initialized at the same
            defined position.
        :param init_sml: The initial SMILES that defines the starting point of the particles in the swarm.
        :param init_emb: The initial position of the particles in the swarm (init_emb = encoder(init_smiles)
        :param num_part: The number of particles that are initialized in the swarm at the given initial position.
        :param v_min: The lower bound of the uniform distribution used to sample the initial velocity.
        :param v_max: The upper bound of the uniform distribution used to sample the initial velocity.
    ...
    def to_dict(self):
        """
        Method to write the swarm with all its properties to a dictionary. This dictionary can be used to reinitialize
            the swarm.
